...
session_config['webapp2_extras.sessions'] = {
    'secret_key': 'brissynbio-equipment-key-fjkdoewjfknvs',
}
...
application = webapp2.WSGIApplication([
    ...
    ('/admin/reports', "report_pages.ReportPage"),
    ('/admin/report/([\w_]+)', "report_pages.ReportPage"),
    ('/admin/report/([\w_]+)/([\w_\d@\.]+)', "report_pages.ReportPage"),
